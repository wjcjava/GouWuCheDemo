package com.example.pc.gouwuchedemo;
...
public class ShoppingCarAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(final int groupPosition, final boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (isSelect_shop) {
            ...
            groupViewHolder.ivSelect.setImageResource(R.mipmap.gouwuche_unselect_bg);
        }
        ...
        if (isSelectAll) {
            ivSelectAll.setBackgroundResource(R.mipmap.xuanze_xuanzhong);
        } else {
            ivSelectAll.setBackgroundResource(R.mipmap.gouwuche_unselect_bg);
        }
        ...
        btnOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (temp != null && temp.size() > 0) {//如果有被选中的
                    ...
                    //Toast.makeText(context, "跳转到确认订单页面，完成后续订单流程", Toast.LENGTH_SHORT).show();
                } else {
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (isSelect) {
            ...
            childViewHolder.ivSelect.setImageResource(R.mipmap.gouwuche_unselect_bg);
        }
